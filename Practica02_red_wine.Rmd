...
En esta práctica unificaremos los datos, los limpiaremos y trataremos de estimar un modelo que a partir de los datos nos pueda predecir los mejores vinos. Este modelo sera aplicado en el subconjunto de las vinos para ver si existe algun razonmiento entre los datos y la calidad del vino y si se puede exportar a otros países o no.
...
# Separo los datos en subsets para poder comparar las características de los vinos de calidad baja/media con los de calidad alta
...
# Hay valores NA en la variable quality_categoric, así que las sustituyo y compruebo
colSums(is.na(practica02))
```
